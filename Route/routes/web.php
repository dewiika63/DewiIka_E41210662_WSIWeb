...
// Route::view('/we;come', 'welcome', ['name' => 'Dewi']);

//     //Parameter Opsional
// Route::get('user/{name?}', function ($name = null) {
//     return $name;
// });
// Route::get('user/{name?}', function ($name = 'Ika') {
//     return $name;
// });
...
//     return $name;
// }) ->where('name', '[A-Za-z]+');
// Route::get('user/{id}', function ($id = '41210662') {
//     return $id;
// }) ->where('id', '[0-9]+');
// Route::get('user/{id}/{name}', function ($id = '41210662', $name = 'Dewiika') {
//     return $name;
//     return $id;
